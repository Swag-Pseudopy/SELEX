...
def get_arg_parser():
    ...
    parser.add_argument('--num_layers', type=int, default=4, #1
                        help='Number of layers in the model')
    parser.add_argument('--num_cross_att', type=int, default=1, #2
                        help='Number of cross-attention layers in the model')
    parser.add_argument('--plot_base', type=str, default='scratch/plots_KL_norm', #'plots_RCA'
                        help='Path to save/load the torch dataset')
    parser.add_argument('--model_dir', type=str, default='scratch/model_KL_norm', #'model_RCA'
                        help='Path to save/load the torch dataset')
    return parser
